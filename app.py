...
def index():
    ...
    stats = {
        ...
        'rev_table' : playstore.groupby(['Category','App','Reviews','Rating'])[['Category','App','Reviews','Rating']].head(10).sort_values('Reviews', ascending=False).reset_index().drop(columns='index').head(10).to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
